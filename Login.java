...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Principale/user_icon_173494(1).png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(443, 477));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Connect();
            pst =(PreparedStatement) con.prepareStatement("select * from connecter where nom=? and mdp=?");
